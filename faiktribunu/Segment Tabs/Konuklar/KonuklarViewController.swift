...
class KonuklarViewController: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    
    
    @IBOutlet weak var kCollectionView: UICollectionView!
    ...
    override func viewDidLoad() {
        ...
        kCollectionView.register(KonuklarCollectionViewCell.self, forCellWithReuseIdentifier: "KonuklarCollectionViewCell")
        kCollectionView.register(UINib.init(nibName: "KonuklarCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "KonuklarCollectionViewCell")
        
        
        self.kCollectionView.addPullToRefresh {
            
            self.kCollectionView.pullToRefreshView.startAnimating()
        ...
        self.kCollectionView.addInfiniteScrolling() {
            
            
            self.kCollectionView.infiniteScrollingView.startAnimating()
            
            self.loadMore += 1
            let urladd = "https://www.faiktribunu.com/index.php/wp-json/wp/v2/posts?categories=388&page=" + "\(self.loadMore)"
                                ...
                                if let item = item.lst{
                                    ...
                                    for title in item{
                                        ...
                                        if item.last?.id == title.id{
                                            ...
                                            self.kCollectionView.infiniteScrollingView.stopAnimating()
                                        }
        ...
        self.kCollectionView.pullToRefreshView.setTitle("Yenilemek için Aşağı Kaydır", forState: 0)
        self.kCollectionView.pullToRefreshView.setTitle("Yenilemekten Vazgeç...", forState: 1)
        self.kCollectionView.pullToRefreshView.setTitle("Yükleniyor...", forState: 2)
    ...
    func loadList(){
        ...
        let url = StaticVariables.baseUrl + "posts?categories=388"
                            ...
                            if let item = item.lst{
                                ...
                                for title in item{
                                    ...
                                    if item.last?.id == title.id{
                                        ...
                                        self.kCollectionView.pullToRefreshView.stopAnimating()
                                    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "KonuklarCollectionViewCell", for: indexPath) as! KonuklarCollectionViewCell
